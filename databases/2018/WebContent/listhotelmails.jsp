...
<body>
	...
	<div class="container">
		<div class="col-md-12 col-sm-12 col-xs-12"">
			<a href="HotelmailsController?action=insert&hotel_id=<c:out value="${hotel_id}"/>"
							...
							<c:forEach items="${mail}" var="mail">
								<tr class="row100">
									...
									<td class="column100 column8"><a
										href="HotelmailsController?action=delete&hotel_id=<c:out value="${hotel_id}"/>&mail=<c:out value="${mail}"/>">Delete</a></td>

...
<html>
<head>
<title>Show All Hotelgroup phones</title>
...
<div class="container">
		<div class="row center">
			...
			<div class="col-md-4 col-sm-6 col-lg-4 col-xs-12"
				...
				<a href="Hotelgroupscontroller?action=listhotelgroups"
					class="btn btn-sm animated-button thar-three"> Admin Hotelgroups</a>
			</div>
	...
	<div class="container">
		<div class="col-md-12 col-sm-12 col-xs-12"">
			<a href="HotelgroupmailsController?action=insert&hotel_group_id=<c:out value="${hotel_group_id}"/>"
				class="btn btn-sm animated-button sandy-four"> Add new mail</a>
		</div>
	</div>
							...
							<c:forEach items="${mail}" var="mail">
								<tr class="row100">
									<td class="column100 column1"><c:out
											value="${hotel_group_id}" /></td>
									<td class="column100 column2"><c:out
											value="${mail}" /></td>
								
									<td class="column100 column8"><a
										href="HotelgroupmailsController?action=delete&hotel_group_id=<c:out value="${hotel_group_id}"/>&mail=<c:out value="${mail}"/>">Delete</a></td>

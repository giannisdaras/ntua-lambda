...
<h3> <img id="lock" src="images/lock.png" alt="not"> You need to be identified in order to reserve a room
 
</h3>
<c:set var="room_id" scope="session" value="${param.room}"/>
<c:set var="hotel_id" scope="session" value="${param.hotel}"/>
<form action="IdentifyCustomer" method="post" name="myForm">
<div class="container">
<div class="Input">
    ...
    <input type="text" style="display:none" value="${room_id}" name="room_id">
    <input type="text" style="display:none" value="${hotel_id}" name="hotel_id">
  </div>
</div>

...
<div class="container">
		<div class="row center">
			...
			<div class="col-md-4 col-sm-6 col-lg-4 col-xs-12"
				...
				<a href="RoomsController?action=listrooms"
					class="btn btn-sm animated-button thar-three"> Admin Rooms</a>
			</div>
	...
	<div class="container">
		<div class="col-md-12 col-sm-12 col-xs-12"">
			<a href="RoomamenitiesController?action=insert&room_id=<c:out value="${room_id}"/>"
				class="btn btn-sm animated-button sandy-four"> Add new amenity</a>
		</div>
	</div>
					...
					<table data-vertable="ver1">
						<thead>
							<tr class="row100-head">
								...
								<th class="column100 column2">Amenity</th>
							...
							<c:forEach items="${amenity}" var="amenity">
								<tr class="row100">
									...
									<td class="column100 column8"><a
										href="RoomamenitiesController?action=delete&room_id=<c:out value="${room_id}"/>&amenity=<c:out value="${amenity}"/>">Delete</a></td>

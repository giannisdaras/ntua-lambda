...
<div class="container">
	...
	<div class="container">
		<div class="col-md-12 col-sm-12 col-xs-12"">
			<a href="HotelgroupphonesController?action=insert&hotel_group_id=<c:out value="${hotel_group_id}"/>"
							...
							<c:forEach items="${phone}" var="phone">
								<tr class="row100">
									...
									<td class="column100 column8"><a
										href="HotelgroupphonesController?action=delete&hotel_group_id=<c:out value="${hotel_group_id}"/>&phone=<c:out value="${phone}"/>">Delete</a></td>
